    ...
    public partial class Report : Form
    {
        ...
        private void ChonBaoCao_Option_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (thangrb.Checked) //chọn thống kê theo tháng
                    command.Parameters["@option"].Value = "Tháng";
                if (namrb.Checked) //chọn thống kê theo năm
                ...
                if (thangrb.Checked) 
                    if (thangtb.Text != "" && namtb.Text == "") //báo cáo theo tháng
                    {
                        ...
                        //thay đổi độ rộng của datagrid
                        //danhsachbaocao.Columns[0].Width = 150;
                       
                    }
                    else //báo cáo theo tháng, năm
                    {
                        table.Columns.Add("Tháng", typeof(int));
